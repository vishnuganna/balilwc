...
import getFoPActivityRecordData from "@salesforce/apex/LandingPageGoldSheetCompletedActivities.getFoPActivityRecordData";
import getFoPActivityRecords from "@salesforce/apex/LandingPageGoldSheetCompletedActivities.getFoPActivityRecords";
...
import Activity_Type from "@salesforce/label/c.Activity_Type";
import Date_Completed from "@salesforce/label/c.Date_Completed";
import GoldSheetCompletedActivities from "@salesforce/label/c.GoldSheetCompletedActivities";
...
const columns = [
    ...
    { label: Activity_Type, fieldName: "activityType", type: "text", sortable: true, hideDefaultActions: true },
    { label: Date_Completed, fieldName: "dateCompleted", type: "text", sortable: true, hideDefaultActions: true }
];
...
export default class landingPageGoldsheetCompletedActivities extends LightningElement {
    // reactive variable
    @track data = [];
    ...
    allLabels = { View_Report, GoldSheetCompletedActivities, FOP_Name };
    ...
    getreportLink() {
        ...
        for (let key in reportName) {
            if (reportName[key] === "KFS Landing-GoldS Completed Activities") {
                result = key;
            }
        }
        ...
        return getFoPActivityRecords({
            ...
            .then(result => {
                ...
                activityList.forEach(activityRec => {
                    ...
                    flatCol.dateCompleted = activityRec.dateField;
                    flatCol.activityType = activityRec.objName;
